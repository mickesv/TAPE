...
CC=g++
PARSERS=parser.o functioncallparser.o loopdepthparser.o functionsizeparser.o verboseparser.o parametercountparser.o callchainparser.o variableaccessparser.o
